...
<c:if test='${mode == "environments"}'>
    <a href="https://ui.honeycomb.io/${team}/environments/${environment}/trace?trace_id=${traceId}&trace_start_ts=${buildStart}&trace_end_ts=${buildEnd}" style="display: block; margin-bottom: 30px;">
</c:if>
